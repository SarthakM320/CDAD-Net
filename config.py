...
feature_extract_dir = 'outputs/extracted_features_public_impl'     # Extract features to this directory
exp_root = 'officehome_ablation_2/'          # All logs and checkpoints will be saved here