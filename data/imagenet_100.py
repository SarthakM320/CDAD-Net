...
class Imagenet100(Dataset):
    def __init__(self, split='train', limit = 0, transform=None):
        ...
        self.data = pd.read_csv(f'../imagenet_100/{split}.csv')
...
def get_imagenet_100_datasets(train_transform, test_transform, train_classes=range(5), prop_train_labels=0.8,
    ...
    train_dataset_labelled = Imagenet100(transform=train_transform,split='train_labelled')
    ...
    train_dataset_unlabelled = Imagenet100(transform=train_transform,split='train_unlabelled')

    # Get test set for all classes
    test_dataset = Imagenet100(split='val', transform=test_transform)
